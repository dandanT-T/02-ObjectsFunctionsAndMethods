...
def try_methods_and_functions():
    tq = rg.SimpleTurtle()
    tq.pen = rg.Pen("blue",5)
    tq.backward(150)
    tq.speed = 1
    draw_many_squares(tq,2,100,30)
    tq.speed = 5
    tq.pen = rg.Pen('red',5)
    draw_many_squares(tq,10, 50, 15)
    tq.speed = 100
    tq.pen = rg.Pen('red',35)
    draw_many_squares(tq,8, 300, 60)
    tq.pen = rg.Pen('black',3)
    tq.backward(200)
    tq.draw_circle(30)
    tq.draw_square(50)
    """
